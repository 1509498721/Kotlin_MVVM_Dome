 ...
 */
object CacheClearUtil {
    /**
     * * 清除本应用内部缓存(/object/object/com.xxx.xxx/cache) * *
     *
     * @param context
     */
    ...
    /**
     * * 清除本应用所有数据库(/object/object/com.xxx.xxx/databases) * *
     *
     * @param context
     */
    ...
    /**
     * * 清除本应用SharedPreference(/object/object/com.xxx.xxx/shared_prefs) *
     *
     * @param context
     */
    ...
    /**
     * * 清除/object/object/com.xxx.xxx/files下的内容 * *
     *
     * @param context
     */
    ...
    /**
     * * 清除外部cache下的内容(/mnt/sdcard/android/object/com.xxx.xxx/cache)
     *
     * @param context
     */
    ...
    private fun deleteFilesByDirectory(dir: File?): Boolean {
        if (dir != null && dir.isDirectory) {
            ...
            for (i in children.indices) {
                val success = deleteFilesByDirectory(File(dir, children[i]))
                if (!success) {
                    return false
                }
            }
    ...
    // 获取文件
    //Context.getExternalFilesDir() --> SDCard/Android/object/你的应用的包名/files/ 目录，一般放一些长时间保存的数据
    //Context.getExternalCacheDir() --> SDCard/Android/object/你的应用包名/cache/目录，一般存放临时缓存数据
