 ...
 * 英文简写（默认）如：12-01
 */
var FORMAT_MONTH_DAY = "MM-slide_left_in"
    /**
     * 英文简写（默认）如：2010-12-01
     */
    var FORMAT_SHORT = "yyyy-MM-slide_left_in"
    /**
     ...
     * 获得默认的 date pattern
     */
    var datePattern = "yyyy-MM-slide_left_in HH:mm:ss"

    var FORMAT_LONG_NEW = "yyyy-MM-slide_left_in HH:mm"
    /**
     * 精确到毫秒的完整时间 如：yyyy-MM-slide_left_in HH:mm:ss.S
     */
    var FORMAT_FULL = "yyyy-MM-slide_left_in HH:mm:ss.S"
    /**
     * 中文简写 如：2010年12月01日
     */
    ...
    // date类型转换为String类型
    // formatType格式为yyyy-MM-slide_left_in HH:mm:ss//yyyy年MM月dd日 HH时mm分ss秒
    // data Date类型的时间
    ...
    // string类型转换为date类型
    // strTime要转换的string类型的时间，formatType要转换的格式yyyy-MM-slide_left_in HH:mm:ss//yyyy年MM月dd日
    // HH时mm分ss秒，
    ...
    // long转换为Date类型
    // currentTime要转换的long类型的时间
    // formatType要转换的时间格式yyyy-MM-slide_left_in HH:mm:ss//yyyy年MM月dd日 HH时mm分ss秒
    @Throws(ParseException::class)
     ...
     * @return
     */
    fun getCurrentTime_Today(): String {
        val sdf = SimpleDateFormat("yyyy-MM-slide_left_in-HH-mm-ss")
    ...
    fun dataOne(time: String): String? {
        val sdr = SimpleDateFormat("yyyy-MM-slide_left_in-HH-mm-ss",
            Locale.CHINA)
        val date: Date
