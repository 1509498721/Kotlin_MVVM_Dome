package com.thesame.baselibrary.utlis.launchstarter;

import android.content.Context;
import android.os.Looper;
import android.util.Log;
import androidx.annotation.UiThread;
import com.thesame.baselibrary.utlis.launchstarter.sort.TaskSortUtil;
import com.thesame.baselibrary.utlis.launchstarter.stat.TaskStat;
...
import com.thesame.baselibrary.utlis.launchstarter.task.TaskCallBack;
...
public class TaskDispatcher {
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = LaunchStarterUtils.isMainProcess(sContext);
        }
    }
